		...
		<section className='pt-16'>
			<div className='text-center mb-12 px-4 sm:px-6 lg:px-8'>
				...
				<p className='text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto'>
					A free platform to help students access quality academic notes.
					No hidden costs, no premium tiers, no catch - everything is completely free.
				</p>
			</div>
					...
					<div className='h-full p-4 sm:p-6 flex items-center'>
						<div className='text-center w-full'>
							...
							<p className='text-xs text-muted-foreground leading-relaxed'>
								Help students access quality academic notes faster. This is our way of
								supporting education and helping students succeed.
							</p>
						</div>
					</div>
				</div>
					...
					<div className='h-full p-4 sm:p-6 flex items-center justify-center'>
						<div className='text-center max-w-3xl'>
							...
							<p className='text-xs sm:text-sm text-muted-foreground leading-relaxed'>
								We believe accessing quality study materials shouldn't be difficult or expensive. This is our
								way of giving back to students and helping them excel in their academics.
								Every note, every download, every resource - completely free for students like you.
							</p>
						</div>
					</div>
				</div>
