...
const TESTIMONIALS = [
  {
    ...
    content:
      "NotesNeo has been a lifesaver! The notes are well-organized and easy to understand. I've improved my grades significantly since I started using it.",
    rating: 5,
    branch: "CSE",
  },
  {
    ...
    content:
      "The best part is the community support. I can find notes for every AI and ML subject. The quality is consistently high. Highly recommend!",
    rating: 5,
    branch: "AIML",
  },
  {
    ...
    content:
      "I love how easy it is to navigate and find exactly what I need. The dark mode is perfect for late-night study sessions. Thank you NotesNeo!",
    rating: 5,
    branch: "DS",
  },
  {
    ...
    content:
      "As a first-year student, NotesNeo helped me adapt quickly. The notes are comprehensive and saved me countless hours of searching for resources.",
    rating: 5,
    branch: "CSE",
  },
  {
    ...
    role: "BTech AIML, 2nd Year",
    content:
      "The favorites feature is amazing! I can save my most-used notes and access them instantly. This platform is a game-changer for students.",
    rating: 5,
    branch: "AIML",
  },
  {
    ...
    content:
      "Finally, a platform that understands what students need. Clean interface, quality content, and completely free. What more could you ask for?",
    rating: 5,
    branch: "DS",
  },
];
