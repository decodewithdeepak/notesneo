					...
					<div className='order-2 lg:order-1'>
						<div className='mb-6'>
							...
							<p className='text-base sm:text-lg text-muted-foreground'>
								Take your study materials everywhere with our mobile app. 
								Access notes offline, get instant updates, and study on the go.
							</p>
						</div>
						...
						<div className='mt-4 space-y-1'>
							...
							<p className='text-xs text-muted-foreground'>
								Developed by <span className='font-medium text-foreground'>Nitish Modi</span> and <span className='font-medium text-foreground'>Preet Raj</span>
							</p>
						</div>
					</div>
