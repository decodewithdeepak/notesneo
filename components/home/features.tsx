'use client';
import { BookOpen, Download, Users, Star, Smartphone, RefreshCw } from 'lucide-react';
	...
	const features = [
		{
			...
			description: 'Access detailed notes for all subjects, covering all units and topics',
		},
		{
			icon: Download,
			...
			<div className='max-w-full mx-auto'>
				<div className='text-center mb-16 px-4 sm:px-6 lg:px-8'>
					<h2 className='font-librebaskerville text-2xl sm:text-3xl md:text-4xl mb-4'>
						...
						<HighlightText>excel</HighlightText>
					</h2>
					<p className='text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto'>
						Access comprehensive study materials organized by branch, semester, and subject for BTech, BCA & BBA students.
					</p>
				</div>
