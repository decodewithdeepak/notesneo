      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-10">
            ...
            <Link to="/resources" className={`nav-link font-semibold text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors text-base ${isActive('/resources')}`}>
              Resources
            </Link>
          ...
          <div className="md:hidden flex items-center space-x-2">
            <Link
              to="/favorites"
              className="p-2 rounded-lg bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors relative"
            >
              <Heart className="w-5 h-5 text-gray-800 dark:text-gray-300" />
              {favorites.length > 0 && (
