  ...
  return (
    <main className="max-w-full flex flex-col gap-8 min-h-full">
      <div className="flex-1">
          ...
          <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center py-12">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
                Browse through our curated collection of Shadcn-inspired
                libraries filtered by your selection.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Search Results */}
        <QuickSearchBase showDefaultResults={false} enableNavigation={true} />
      </div>
    </main>
  );
}
