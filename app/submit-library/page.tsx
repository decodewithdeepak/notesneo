...
export default function SubmitLibraryPage() {
  ...
  const [lastSubmission, setLastSubmission] =
    useState<SubmitLibraryFormValues | null>(null);
        ...
        {!isSubmitted ? (
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Share a great component library with the community.
            </p>
          </div>
        ) : (
          <div className="mb-6 sm:mb-8">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Public, human-friendly name for the library.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Direct link to the source or official site.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start gap-3 space-y-0 rounded-md border p-3">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Indicate if it’s installable via the shadcn/ui
                          registry.
                        </FormDescription>
                      </div>
                    </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start gap-3 space-y-0 rounded-md border p-3">
                      ...
                      <div className="space-y-1 leading-none">
                        ...
                        <FormDescription>
                          Affirms the library exports composable, reusable
                          pieces.
                        </FormDescription>
                      </div>
                    </FormItem>
              ...
              <FormField
                ...
                rules={{
                  ...
                  maxLength: {
                    value: 80,
                    message: "Author must be at most 80 characters",
                  },
                }}
                render={({ field }) => (
                  <FormItem>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        rows={5}
                        placeholder="What makes this library great?"
                        {...field}
                      />
                    </FormControl>
          ...
          <div className="space-y-5">
            <div className="rounded-md border p-4">
              <p className="text-sm text-muted-foreground">
                ...
                details for accuracy and completeness. They may make minor edits
                to ensure consistency with our guidelines. If it fits the
                requirements, it will be added to the public list.
              </p>
            </div>
                ...
                <div className="rounded-md border p-4">
                  ...
                  <div className="text-sm text-muted-foreground space-y-1">
                    ...
                    <p>
                      ...
                      {lastSubmission.usesShadcnRegistry ? "Yes" : "No"}
                    </p>
                    <p>
                      <span className="text-foreground">
                        Provides reusable components:
                      </span>{" "}
                      {lastSubmission.providesReusableComponents ? "Yes" : "No"}
                    </p>
                  </div>
                </div>
              ) : null}
